...
{stateid:12, state:'Kerala', data:[
  {
    name: 'Allepey',
    description: `Allepey vacations promise to offer loads of fun, beauty and adventure. If you want to take a break from the stressful daily life travel to Alleppey and make your holidays the most memorable one. Alleppey also known as Alappuzha is the city of canals and lagoons. Alleppey is the hub of backwater tourism. This huge backwaters of canals, lagoons and lakes provide the lifeline of Alleppey. You might be surprised to know that Alleppey is the only city in Kerala without forests.`,
...
{stateid:14,state:'Maharastra', data:[
  {
...
{stateid:24,state:'Telangana',data:[
  {
    name: 'Charminar',
...
{stateid:32, state:'ANDAMAN AND NICOBAR', data:[
  ...
  },
  {
    ...
    image: '/images/Scuba Diving In Andaman.png',
  }
]},
...
const Places = () => {
    ...
    <div className="bg">
      ...
      <div className="theme-image">
        ...
        <div className="theme-image">
          ...
          <div className="theme-image">
            <img src="/images/hillstation-tour.svg" alt="Beach" />
            <h5>HILL STATION</h5>
          </div>
    </div>
  ...
  <center>
  <button class="button"> More Places . . .  < i class="fa-solid fa-arrow-right"></i> </button>
